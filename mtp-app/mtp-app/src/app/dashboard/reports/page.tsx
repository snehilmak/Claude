...
export default async function ReportsPage({ searchParams }: PageProps) {
  ...
  const [transactions, byCompany, ctrCustomers] = await Promise.all([
    ...
    // CTR: customers with aggregate sends >= $1000 in the date range
    prisma.transaction.groupBy({
      by: ['customerId'],
      where: {
        organizationId: session.organization.id,
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">Compliance and summary reports</p>
      </div>
        ...
        <Card className="border-red-200">
          ...
          <CardContent>
            <p className="mb-4 text-sm text-red-600">
              The following customers sent $1,000 or more in this period. Review for Currency
              Transaction Report (CTR) filing requirements.
            </p>
